...
function gateV0(facts) {
  ...
  if (ILLEGAL.some(k => text.includes(k))) return { action: "skip", reason_codes: ["illegal_keyword"], human_required: true };
